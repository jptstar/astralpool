...
TEMPERATURE_CALIBRATION_DELAY_SECONDS: Final = 15.0
...
async def async_calibrate_temperature(api: Any, reference_temperature: float) -> None:
    ...
    3. wait 15 seconds for the controller to apply the calibration.
    """
...
async def async_reset_temperature_calibration(api: Any) -> None:
    ...
    Validated on real Smart Next hardware: trigger 0xB0D and wait 15 seconds
    for the displayed temperature to return to the factory calibration.
    """
